...
(async()=>{
 ...
 await page.locator("a[href]").evaluateAll(links=>links.forEach(a=>{const raw=a.getAttribute("href");if(raw && !/^(https?:|#)/.test(raw))a.href="https://github.com/Vesta-Software-Group/vesta-companion/blob/main/"+raw}));
