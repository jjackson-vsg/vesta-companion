...
1. Determine the meeting or review window, timezone and desired outcome. Read local projects, contacts, decisions and tasks first.
2. For a meeting, use the selected event and relevant approved thread context only. Produce a short objective, agenda, attendee context, decisions needed, evidence and questions. Mark assumptions.
3. For a weekly review, compare actual outputs and commitments with the plan. Identify completed outcomes, blockers, unresolved commitments, decisions and next week's proposed focus.
